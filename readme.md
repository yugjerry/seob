...
- Paper (arXiv): https://arxiv.org/abs/2502.09569
- This repo currently contains:
  - `simu.py`: core SE-OB / QRE routines
  - `simu.ipynb`: simulation notebook
  - `convergence.ipynb`: convergence illustration notebook
